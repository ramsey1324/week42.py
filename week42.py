...
print(result[0:4])
#findtheworktext
# index slicing is when you get a substring from string. you can get a substring by specifying the start and the end of an index of the substring. The star index in inclusive and the end index is exclusive
...
print(result(-3))
print(result[-5])
#-1 means the subsring is not found
###slide 5
